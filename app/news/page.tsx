...
export default function News() {
  ...
  const [newsItems] = useState([
    {
      id: 1,
      title: "ورشة تكوينية حول مكافحة الفساد",
      date: "2025-11-15",
      category: "ورشات عمل",
      image: "🎓",
      excerpt:
        "تنظيم ورشة تكوينية لفائدة موظفي الإدارات العمومية حول آليات مكافحة الفساد وتعزيز الشفافية",
      description:
        "نظم المكتب الولائي ورشة تكوينية مكثفة استهدفت موظفي الإدارات العمومية، حيث تم التطرق إلى أهم آليات مكافحة الفساد وتعزيز ثقافة النزاهة في العمل الإداري.",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      category: "اجتماعات",
      image: "🤝",
      excerpt: "اجتماع تنسيقي مع السلطات المحلية لتعزيز التعاون في مكافحة الفساد",
      description:
        "عقد المكتب الولائي اجتماعاً تنسيقياً مع ممثلي السلطات المحلية والهيئات الرقابية، لتعزيز التعاون والتنسيق في مجال مكافحة الفساد وحماية المال العام.",
    },
    {
      id: 4,
      ...
      <section className="bg-gradient-to-r from-purple-600 to-purple-800 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto">
            تابع آخر أخبارنا ونشاطاتنا الميدانية في مجال مكافحة الفساد
          </p>
        </div>
      </section>
